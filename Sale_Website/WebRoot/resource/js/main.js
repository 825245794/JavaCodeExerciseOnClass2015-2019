...
function forward(a,s){
	window.location.href="cart!updateProduct?productid="+a+"&quantity="+s;
}
function delforward(a){
	window.location.href="cart!deleteProductInCart?productid="+a;
}