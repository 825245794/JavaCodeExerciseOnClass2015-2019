...
-->
  ...
  <body bgcolor="#FDF3EE">
   ...
   <table width="1000" height="638" border="1" cellpadding="0" cellspacing="0" bgcolor="#FFE8E8">
     ...
     <tr>
        <td valign="top">
          <div id="title">新增收货地址</div>
          <form id="form1" name="form1" method="post" action="shoping/addAddressCart">
  ...
  <table width="50%" border="0" align="left" cellpadding="0" cellspacing="0">
    <tr>
      ...
      <td height="30"><label>
        ...
        <textarea name="dress.address" cols="20" rows="4"></textarea>
      </label></td>
    </tr>
    <tr>
      <td height="30"><div align="right" class="intputText">邮政编码：</div></td>
      <td height="30"><label>
        <input name="dress.post" type="text" class="input" id="post" />
      </label></td>
    </tr>
    <tr>
    ...
    <tr>
      <td height="30" colspan="2"><label>
        ...
        <div align="center">        
          <input type="radio" name="dress.def" value="1" />
          <span class="intputText"> 设为默认收货地址</span></div></td>
      </tr>
    <tr>
