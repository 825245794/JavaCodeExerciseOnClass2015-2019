...
<body bgcolor="#FDF3EE">
   ...
   <table width="1000" height="600" border="1" cellpadding="0" cellspacing="0" bgcolor="#FFE8E8">
      <tr>
        <td valign="top">
		  <form action="shoping/orderSubmit?modle=2" method="post" name="form1">
		
<!-- *************收货地址************************************************************* -->			
		<s:if test="addressNum==0">
		    <div id="div1">
            <p><a href="user/addAddressCart.jsp">请输入收货地址</a></p>
          </div>
           ...
           <s:iterator value="listAddress">
            ...
            <s:else>
             ...
             <tr> 
              ...
              <a href="shoping/getUpdateAddressCart?addressid=<s:property value='addressid'/>">修&nbsp; 改</a> 
              | <a href="shoping/deleteAddressCart?addressid=<s:property value='addressid'/>">删&nbsp; 除</a></p>
              <p>&nbsp;</p></td>
            </tr>
           </s:iterator> 
            <script type="text/javascript">
            ...
            <tr>
              <td height="30" colspan="3">&nbsp;&nbsp; &nbsp;<a href="user/addAddressCart.jsp">使用新地址</a></td>
            </tr>
	...
	<!-- 使用隐藏域传递购物车信息 -->	
	    <input type="hidden" name="addressid" value="<s:property value='addressid'/>">
          ...
          <s:iterator value="listGoods" status="c">
            ...
            <tr>
              <td height="36" colspan="5" bgcolor="#FFE1F0"><div align="right">&nbsp;运费：&nbsp;¥5.00&nbsp;&nbsp;&nbsp;&nbsp; </div></td>
            </tr>
            <tr>
              <td height="42" colspan="5" bgcolor="#FFE1F0"><div align="right"><span class="STYLE1">合计(含运费) ：¥</span>
                <input name="amount" type="text" class="input2" value="<s:property value='amount+5'/>" />
                  &nbsp;&nbsp;&nbsp; </div></td>
            </tr>
          </table>
           <label></label>
